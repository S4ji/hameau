...
const features = [
  ...
  },
  {
    ...
    description:
      "Nous écoutons vos projets RP dans ce serveur où seul vos actions feront évoluer les terres. ",
    icon: "bx:bxs-data",
  },
  {
    title: "Trouvez votre place !",
    description:
      " Devenez mage, guerrier ou voleur, tout le monde trouve sa place, même les grands méchants ont leurs places.",
    icon: "bx:bxs-bot",
  },
  {
    title: "SEO Enabled",
